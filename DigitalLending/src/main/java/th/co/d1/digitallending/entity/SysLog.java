...
public class SysLog implements Serializable {
    ...
    public SysLog(String uuid, String prodCode, String caseId, int status) {
        this.uuid = uuid;
    ...
    public String toString() {
        return "SysLog{" + "uuid=" + uuid + ", prodCode=" + prodCode + ", caseId=" + caseId + ", groupProduct=" + groupProduct + ", state=" + state + ", attr1=" + attr1 + ", attr2=" + attr2 + ", attr3=" + attr3 + ", attr4=" + attr4 + ", attr5=" + attr5 + ", attr6=" + attr6 + ", attr7=" + attr7 + ", attr8=" + attr8 + ", attr9=" + attr9 + ", attr10=" + attr10 + ", status=" + status + ", createAt=" + createAt + ", createBy=" + createBy + ", updateAt=" + updateAt + ", updateBy=" + updateBy + '}';
    }
